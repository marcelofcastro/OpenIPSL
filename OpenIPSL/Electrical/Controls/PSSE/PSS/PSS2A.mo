...
model PSS2A "PSS2A - 1992 IEEE Dual-Input Stabilizer Model"
  extends BaseClasses.BasePSS;
  parameter SI.Time T_w1=10 "Washout 1 time constant";
  parameter SI.Time T_w2=10 "Washout 2 time constant";
  parameter SI.Time T_6=1e-9 "Lag 1 time constant";
  parameter SI.Time T_w3=10 "Washout 3 time constant";
  parameter SI.Time T_w4=1e-9 "Washout 4 time constant";
  parameter SI.Time T_7=10 "Lag 2 time constant";
  parameter SI.Time K_S2=0.99 "Lag 2 gain";
  parameter SI.PerUnit K_S3=1 "gain";
  ...
  parameter SI.Time T_1=0.15
    "Leadlag1 time constant (data from IEEE std, not representative, need to be tuned following system parameters)";
  parameter SI.Time T_2=0.025 "Leadlag1 time constant";
  parameter SI.Time T_3=0.15 "Leadlag2 time constant";
  parameter SI.Time T_4=0.025 "Leadlag2 time constant";
  parameter SI.PerUnit V_STMAX=0.1 "PSS output limiation";
  parameter SI.PerUnit V_STMIN=-0.1 "PSS output limiation";
