...
model PSS2B "PSS2B - 2005 IEEE Dual-Input Stabilizer Model"
  extends BaseClasses.BasePSS;
  parameter SI.Time T_w1=10 "Washout time constant 1";
  parameter SI.Time T_w2=10 "Washout time constant 2";
  parameter SI.Time T_6=1e-9 "Lag time constant 6";
  parameter SI.Time T_w3=10 "Washout time constant 3";
  parameter SI.Time T_w4=1e-9 "Washout time constant 4";
  parameter SI.Time T_7=10 "Lag time constant 7";
  parameter SI.PerUnit K_S2=0.99 "Lag gain 2, T_7/H";
  parameter SI.PerUnit K_S3=1 "Lag gain 3";
  parameter SI.Time T_8=0.5 "Ramp-tracking filter time constant";
  parameter SI.Time T_9=0.1 "Ramp-tracking filter time constant";
  parameter SI.PerUnit K_S1=20 "PSS gain";
  parameter SI.Time T_1=0.15 "Lead-lag time constant 1";
  parameter SI.Time T_2=0.025 "Lead-lag time constant 2";
  parameter SI.Time T_3=0.15 "Lead-lag time constant 3";
  parameter SI.Time T_4=0.025 "Lead-lag time constant 4";
  parameter SI.Time T_10=1e-9 "Lead-lag time constant 10";
  parameter SI.Time T_11=0.033 "Lead-lag time constant 11";
  parameter SI.PerUnit V_S1MAX=0.08 "PSS input 1 max. limit";
  parameter SI.PerUnit V_S1MIN=-0.08 "PSS input 1 min. limit";
  parameter SI.PerUnit V_S2MAX=1.25 "PSS input 2 max. limit";
  parameter SI.PerUnit V_S2MIN=-1.25 "PSS input 2 min. limit";
  parameter SI.PerUnit V_STMAX=0.1 "PSS output max. limit, 0.1 ~ 0.2";
  parameter SI.PerUnit V_STMIN=-0.1 "PSS output min. limit, -0.05 ~ -0.1";
