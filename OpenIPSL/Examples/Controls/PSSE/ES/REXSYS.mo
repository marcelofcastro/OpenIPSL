...
model REXSYS "SMIB model example of GENROE with Excitation System REXSYS"
...
equation
  ...
  connect(gENROE.XADIFD, rEXSYS.XADIFD) annotation (Line(points={{-46,-18},{
          -42,-18},{-42,-22},{-78,-22},{-78,-59}}, color={0,0,127}));
  connect(VUEL.y, rEXSYS.VUEL) annotation (Line(points={{-58.6,-52},{-66,-52},
          {-66,-59}}, color={0,0,127}));
  connect(VOEL.y, rEXSYS.VOEL) annotation (Line(points={{-58.6,-34},{-70,-34},
          {-70,-59}}, color={0,0,127}));
  connect(rEXSYS.EFD0, gENROE.EFD0) annotation (Line(points={{-59,-66},{-40,
          -66},{-40,-10},{-46,-10}}, color={0,0,127}));
  connect(gENROE.ETERM, rEXSYS.ECOMP) annotation (Line(points={{-46,-6},{-38,
          -6},{-38,-70},{-59,-70}}, color={0,0,127}));
  connect(PSS_off.y, rEXSYS.VOTHSG)
    annotation (Line(points={{-34.4,-74},{-59,-74}}, color={0,0,127}));
  connect(rEXSYS.EFD, gENROE.EFD) annotation (Line(points={{-81,-70},{-100,
